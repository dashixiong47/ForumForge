DROP TABLE IF EXISTS plugin_share_events;
...
-- The first admin user is created by Worker bootstrap using ADMIN_EMAIL,
-- ADMIN_USERNAME and ADMIN_PASSWORD environment variables.
-- Configure them in .dev.vars or Worker secrets before first login.
