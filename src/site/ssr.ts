			...
			<main class="settings-main">
				<div class="settings-section-grid">
					...
					<section class="panel settings-section email-section"><h2 data-i18n="settings.emailBinding">绑定邮箱</h2><div class="panel-body">
						${user.email ? `<div class="current-email-row"><span class="label muted" data-i18n="settings.currentEmail">当前邮箱</span><span class="current-email-value">${user.email}</span>${user.verified ? '<span class="badge badge-ok" data-i18n="settings.verified">已验证</span>' : '<span class="badge badge-warn" data-i18n="settings.unverified">未验证</span>'}</div>` : ''}
						${user.pending_email ? `<div class="pending-email-row"><span class="label muted" data-i18n="settings.pendingEmail">待确认</span><span class="pending-email-value">${user.pending_email}</span><span class="badge badge-warn" data-i18n="settings.awaitingConfirm">等待确认</span></div>` : ''}
						<div class="settings-form-grid">
							<div class="field setting-field-narrow"><label data-i18n="settings.newEmail">${user.email ? '更换邮箱' : '绑定邮箱'}</label><input name="new_email" type="email" form="change-email-form" placeholder="name@example.com" maxlength="254"></div>
						</div>
